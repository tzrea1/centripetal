...
public class AuditorQuizAcitvityController extends BaseController {
  ...
  public TableDataInfo list(AuditorQuizAcitvity auditorQuizAcitvity) {
    startPage();
    List<AuditorQuizAcitvity> list = auditorQuizAcitvityService.selectAuditorQuizAcitvityList(
        auditorQuizAcitvity);
  ...
  public void export(HttpServletResponse response, AuditorQuizAcitvity auditorQuizAcitvity) {
    List<AuditorQuizAcitvity> list = auditorQuizAcitvityService.selectAuditorQuizAcitvityList(
        auditorQuizAcitvity);
    ExcelUtil<AuditorQuizAcitvity> util = new ExcelUtil<AuditorQuizAcitvity>(
        AuditorQuizAcitvity.class);
  ...
  public AjaxResult getInfo(AuditorQuizAcitvity auditorQuizAcitvity) {
    return success(
        auditorQuizAcitvityService.selectAuditorQuizAcitvityByAuditorId(auditorQuizAcitvity));
  }
  ...
  public AjaxResult remove(@RequestBody List<AuditorQuizAcitvity> auditorQuizAcitvities) {
    return toAjax(
        auditorQuizAcitvityService.deleteAuditorQuizAcitvityByAuditorIds(auditorQuizAcitvities));
  }
}
