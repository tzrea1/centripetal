...
import com.joyboys.common.enums.BusinessStatus;
import com.joyboys.common.enums.HttpMethod;
import com.joyboys.common.filter.PropertyPreExcludeFilter;
...
public class LogAspect {
  ...
  private void setRequestValue(JoinPoint joinPoint, SysOperLog operLog, String[] excludeParamNames)
    ...
    if (StringUtils.isEmpty(paramsMap)
        && (HttpMethod.PUT.name().equals(requestMethod) || HttpMethod.POST.name()
