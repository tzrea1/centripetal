...
public interface IAuditorQuizAcitvityService 
{
     ...
     * @return 审核员审核答题活动的记录
     */
    public AuditorQuizAcitvity selectAuditorQuizAcitvityByAuditorId(AuditorQuizAcitvity auditorQuizAcitvity);
     ...
     */
    public List<AuditorQuizAcitvity> selectAuditorQuizAcitvityList(AuditorQuizAcitvity auditorQuizAcitvity);
